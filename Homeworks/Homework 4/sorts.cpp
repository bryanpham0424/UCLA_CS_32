...
int main()
{
    ...
    // destruction time.
    {
        ...
        for (int i = 0; i < studentsObjs.size(); i++) {
            students[i] = *studentsObjs[i];
        }
